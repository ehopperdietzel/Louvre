...
static struct wl_output_interface output_implementation = {&output_release};
...
void output_bind(wl_client *client, void *data, UInt32 version, UInt32 id)
{
    ...
    wl_resource_set_implementation(resource, &output_implementation, nullptr, &output_resource_destroy);
